# Коллега! Так как я не разобрался с этим мутным заданием и так и не понял, зачем писать столько кода вместо 7 строчек в HTML, то 
# выложил код из примера. Я разобрался, Как этот код работает. Пока этого достаточно.
